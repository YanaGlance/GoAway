...
public class ReservationRepository extends RepositoryBase<Client> implements IClientRepository{
	
    private PreparedStatement getMeal;
    private PreparedStatement getRecomendation;
	...
	public ReservationRepository(Connection connection,
		...
		try{
		    getMeal = connection.prepareStatement(getNameSql());
		    getRecomendation = connection.prepareStatement(getSurnameSql());
